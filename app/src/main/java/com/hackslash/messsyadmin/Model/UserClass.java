...
public class UserClass {
    ...
    String  Name , Email , Mobile, HostelName, Designation , imageUrl , UId;
    ...
    public UserClass(String name, String email, String mobile, String hostelName, String designation, String imageUrl) {
        Name = name;
        Email = email;
        Mobile = mobile;
