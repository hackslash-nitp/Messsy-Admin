...
public class MessConversationFragment extends Fragment {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new AdminGroupTalkFragment(),"Group Talk");//here using admin group talk because both are sme
